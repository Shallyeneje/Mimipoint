...
export default function ForgotPassword() {
  ...
  return (
    <div className="flex h-100vh bg-white">
      ...
      {/* Right Section - Form */}
      <div className="w-full md:w-[40%] flex flex-col justify-center px-12 py-16 relative">
        ...
        {successMessage && (
          <div className="bg-green-100 border border-[#D9FFD9] text-[#009900] px-4 py-3 rounded-md flex items-start gap-2 text-sm shadow-md mb-4">
            ...
            <div>
              ...
              <p>Password reset link has been sent to your email, kindly check your inbox.</p>
            </div>
          </div>
        )}

        <h1 className="text-2xl font-bold text-[#00005D] mb-6">Enter your email</h1>
